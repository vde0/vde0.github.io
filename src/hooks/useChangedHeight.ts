...
export type GetChangedHeight = () => number;
const getChangedHeight: GetChangedHeight = defineChangedHeight(() => webApp.viewportHeight);

export const useChangedHeight = (getCH: GetChangedHeight = getChangedHeight): number => {
...
export function defineChangedHeight(getHeight: () => number): GetChangedHeight {
