...
export type IsUncapitale<L extends string> = L extends Uncapitalize<L> ? true : false;
export type IsCapitale<L extends string> = L extends Capitalize<L> ? true : false;
...
export type IfUncapitale<L extends string, Then, Else> = IsUncapitale<L> extends true ? Then : Else;
export type IfCapitale<L extends string, Then, Else> = IsCapitale<L> extends true ? Then : Else;
...
export type PascalCase<S extends string> = Capitalize<CamelCase>;
